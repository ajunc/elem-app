  ...
  <div class="area" ref="area_scroll" v-if="cityInfo">
    <div class="scroll_wrap">
        <div class="hot_wrap citylist">
            ...
            <ul class="hot_city">
                <li @click="$emit('selectCity',item)" v-for="(item,index) in cityInfo.hotCities" 
        ...
        <div class="city_wrap">
            ...
            :key="index">
                ...
                <!-- 根据字母key展示城市名 -->
                <ul>
                    <li @click="$emit('selectCity',city)" v-for="(city,index) in cityInfo[item]" 
    ...
    <div class="area_keys">
        <ul>
            ...
            <li @click="selectKey(index+1)" v-for="(item,index) in keys" 
            :key="index">{{item}}</li>
        </ul>
    </div>
  </div>
