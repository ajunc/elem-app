<template>
  <div class="city">
    <div class="search_wrap">
        ...
        <button @click="$router.push({name:'addresss',params:{city:city}})">取消</button>
    </div>
...
export default {
    ...
    methods:{
        ...
        selectCity(city){
            //console.log(city)
            this.$router.push({name:'addresss',params:{
                city:city.name
            }})
        },
        searchCity() {
            if(!this.city_val) {
                ...
                //根据输入框的关键字监所城市 并且存入到searchList数组中
